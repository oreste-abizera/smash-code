  ...
  return (
    <>
      ...
      <main className="bg-[#363947] w-full min-h-screen px-4 lg:px-[6rem] py-[10rem]">
        <div className="w-full flex flex-col lg:flex-row border-r-[2px] border-dashed border-r-[#008B9A]">
          <div className="w-full lg:w-1/2">
            <Title title={"Who we"} subtitle="Are?"></Title>
            <p className="text-white py-[15px] px-[4px] text-[1.2rem] mb-[1rem]">
              Fuller Teams is a team of skilled Developers, Graphic Designers,
              and Copy Writers committed to fulfilling the needs of our clients
              to their satisfaction level. We work hard to keep up with
              innovative solutions. We focus on unique designs and robust
              development from start to finish so that you remain focused on
              your core business.
            </p>
            <button
        ...
        <div className="w-full flex flex-col lg:flex-row border-l-[2px] border-dashed border-l-[#008B9A] pl-[2rem] my-[4rem]">
          <div className="w-full lg:w-1/2">
            <Title title={"Our"} subtitle="Missions"></Title>
            <p className="text-white py-[50px] px-[4px] text-[1.2rem] mb-[1rem]">
              Fuller Teams aims to provide depth and breadth services to our
        ...
        <div className="w-full flex flex-col lg:flex-row border-r-[2px] border-dashed border-r-[#008B9A] pr-[2rem] mb-[4rem]">
          <div className="w-full lg:w-1/2">
        ...
        <div className="w-full border-r-[2px] border-dashed border-r-[#008B9A] pr-[2rem] my-[4rem]">
          <Title title={"Meet our"} subtitle="Team"></Title>
          <TeamMembers />
        </div>

        <div className="w-full flex flex-col lg:flex-row border-l-[2px] border-dashed border-l-[#008B9A] pl-[2rem]">
          <div className="w-full lg:w-1/2">
            ...
            <p className="text-white py-[70px] px-[4px] text-[1.2rem] mb-[1rem]">
              ...
              USA founded in 2022 Our team consists of skilled Web Designers
              &amp; Developers, Graphic Designers, and Copy Writes. We offer
              quality services of unique web designs &amp; robust developments,
